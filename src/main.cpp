...
const float FRONT_DIST_OFFSET = 6.25;
const float LEFT_DIST_OFFSET = 5.75;
const float RIGHT_DIST_OFFSET = 5.5;
...
void autonomous() {
	...
	if (auton_num == 0) {
		...
		pros::Task align_score1{[=]{
			while(back_dist.get_distance() > 85) { pros::delay(50);}
			upper.move(127);
		}};
		...
		// Get matchloader
		chassis.moveToPoint(-47.878, -48, 2000, {.forwards = true, .maxSpeed = 127});
		chassis.turnToHeading(-90, 2000);
		chassis.moveToPoint(-56.12, -47.04, 2000, {.forwards = true, .maxSpeed = 127}, false);
		left_mg.move(-50);
		right_mg.move(-50);
		pros::delay(250);
		left_mg.move(50);
		...
		// Score long goal
		chassis.moveToPoint(-28.03, -47.32, 2000, {.forwards = false, .maxSpeed = 50});
		pros::Task align_score1{[=]{
			while(back_dist.get_distance() > 85) { pros::delay(50);}
			upper.move(127);
		}};
		...
		chassis.moveToPose(-23.01, -23.33, 45, 2000, {.forwards = true, .maxSpeed = 127});
		...
		chassis.turnToHeading(90, 2000);
		chassis.moveToPoint(41.40, -21.84, 5000, {.forwards = true, .maxSpeed = 127});
		chassis.turnToHeading(180, 2000);
		chassis.moveToPoint(45.19, -44.33, 5000, {.forwards = true, .maxSpeed = 100});

	
		// Score second long goal
		chassis.turnToHeading(90, 2000);
		chassis.moveToPoint(30, -44.50, 2000, {.forwards = false, .maxSpeed = 65});
		pros::Task align_score2{[=]{
			while(back_dist.get_distance() > 85) { pros::delay(50);}
			upper.move(127);
		}};
		...
		chassis.turnToHeading(90, 2000);
		matchload.set_value(true);
		chassis.moveToPoint(59.76, -43.65, 2000, {.forwards = true, .maxSpeed = 127}, false);
		left_mg.move(-50);
		right_mg.move(-50);
		pros::delay(250);
		left_mg.move(50);
		...
		// Go to matchloader 3
		chassis.moveToPoint(43, -43.65, 2000, {.forwards = false});
		chassis.turnToHeading(0, 2000);
		chassis.moveToPoint(43, 50.31, 2000, {.forwards = true});

		// Score long goal 3
		chassis.turnToHeading(90, 2000);
		chassis.moveToPoint(28, 50.32, 2000, {.forwards = false, .maxSpeed = 50});
		...
		// Get matchloader
		chassis.moveToPoint(59.34, 51.34, 2000, {.forwards = true, .maxSpeed = 127}, false);
		left_mg.move(-50);
		right_mg.move(-50);
		pros::delay(250);
		left_mg.move(50);
		...
		// Get 4th trio
		chassis.moveToPoint(42, 50.32, 2000, {.maxSpeed=127});
		matchload.set_value(false);
		chassis.turnToHeading( 180, 2000);
		// chassis.moveToPoint(35, 35, 2000);
		chassis.moveToPose(23.67, 21.85, -135, 2000, {.maxSpeed = 127});
		// chassis.waitUntil(15);
		// matchload.set_value(true);
		pros::delay(1000);

		// Get 5th trio
		chassis.turnToPoint(-26.24, 21.85, 2000);
		chassis.moveToPoint(-26.24, 21.85, 2000, {.forwards = true, .maxSpeed = 127});
		chassis.waitUntil(10);
		matchload.set_value(false);
		// chassis.waitUntil(20);
		// matchload.set_value(true);
		...
		chassis.moveToPoint(-8.75, 10.75, 2000, {.forwards = false, .maxSpeed = 50}, false);
		chassis.turnToHeading(-45, 2000);
		level.set_value(true);
		pros::delay(200);
		upper.move(127);
		...
		// Go to matchloader 4
		chassis.moveToPoint(-49.05, 45.36, 2000, {.forwards = true, .maxSpeed = 127});
		level.set_value(false);
		chassis.turnToHeading(-90, 2000);
		matchload.set_value(true);

		// Get matchloader 4
		chassis.moveToPoint(-57.99, 44.36, 2000, {.forwards = true, .maxSpeed = 127}, false);
		left_mg.move(-50);
		right_mg.move(-50);
		pros::delay(250);
		left_mg.move(50);
		...
		// Score long goal 4
		chassis.moveToPoint(-27.00, 45.36, 2000, {.forwards = false, .maxSpeed = 50});
	...
	else if (auton_num == 50) {

		// Skills
		odom.set_value(false);
		chassis.setPose(-72 + RIGHT_DIST_OFFSET + right_dist.get_distance() * MM_TO_IN, -72 + FRONT_DIST_OFFSET + front_dist.get_distance() * MM_TO_IN,180);
		...
		// Get matchloader
		chassis.moveToPoint(-48, -47, 2000, {.forwards = true, .maxSpeed = 127});
		chassis.turnToHeading(-90, 2000);
		chassis.moveToPoint(-60, -47, 2000, {.forwards = true, .maxSpeed = 127}, false);
		left_mg.move(-50);
		right_mg.move(-50);
		pros::delay(250);
		left_mg.move(50);
		...
		// Score long goal
		chassis.moveToPoint(-28, -47, 2000, {.forwards = false, .maxSpeed = 50});
		pros::Task align_score1{[=]{
			while(back_dist.get_distance() > 85) { pros::delay(50);}
			upper.move(127);
		}};
		chassis.turnToHeading(-90, 2000, {}, false);
		pros::delay(3000);
		chassis.setPose(chassis.getPose().x, -72 + LEFT_DIST_OFFSET + left_dist.get_distance() * MM_TO_IN, chassis.getPose().theta); 
		upper.move(0);
		matchload.set_value(false);
		...
		chassis.moveToPose(-22, -22, 45, 2000, {.forwards = true, .maxSpeed = 127});
		chassis.waitUntil(10);
		// matchload.set_value(true);
		pros::delay(500);
		...
		chassis.turnToHeading(90, 2000);
		chassis.moveToPoint(41.40, -22, 5000, {.forwards = true, .maxSpeed = 127}, false);
		chassis.turnToHeading(90, 2000, {}, false);
		pros::delay(1000);
		chassis.setPose(72 - FRONT_DIST_OFFSET - front_dist.get_distance() * MM_TO_IN, -72 + RIGHT_DIST_OFFSET + right_dist.get_distance() * MM_TO_IN, chassis.getPose().theta); 
		chassis.turnToHeading(180, 2000);
		chassis.moveToPoint(47, -47, 5000, {.forwards = true, .maxSpeed = 100});

	
		// Score second long goal
		chassis.turnToHeading(90, 2000);
		chassis.moveToPoint(28, -48, 2000, {.forwards = false, .maxSpeed = 65});
		pros::Task align_score2{[=]{
			while(back_dist.get_distance() > 85) { pros::delay(50);}
			upper.move(127);
		}};
		chassis.turnToHeading(90, 2000, {}, false);
		pros::delay(3000);
		chassis.setPose(chassis.getPose().x, -72 + RIGHT_DIST_OFFSET + right_dist.get_distance() * MM_TO_IN, chassis.getPose().theta); 
		upper.move(0);
		...
		chassis.turnToHeading(0, 2000);
		chassis.moveToPoint(43, 47, 2000, {.forwards = true});
		...
		// Get 4th trio
		chassis.moveToPoint(47, 47, 2000, {.maxSpeed=127});
		matchload.set_value(false);
		chassis.turnToHeading( 180, 2000);
		// chassis.moveToPoint(35, 35, 2000);
		chassis.moveToPose(22, 22, -135, 2000, {.maxSpeed = 127});
		// chassis.waitUntil(15);
		// matchload.set_value(true);
		pros::delay(1000);

		// Get 5th trio
		chassis.turnToPoint(-25, 22, 2000);
		chassis.moveToPoint(-25, 22, 2000, {.forwards = true, .maxSpeed = 127});

		chassis.turnToHeading(-90, 1000, {}, false);
		pros::delay(1000);
		chassis.setPose(-72 + FRONT_DIST_OFFSET + front_dist.get_distance() * MM_TO_IN, chassis.getPose().y, chassis.getPose().theta); 
		...
		// Score middle goal
		chassis.turnToHeading(-45, 2000);
		chassis.moveToPoint(-12, 12, 2000, {.forwards = false, .maxSpeed = 50}, false);
		chassis.turnToHeading(-45, 2000);
		level.set_value(true);
		pros::delay(200);
		upper.move(127);
